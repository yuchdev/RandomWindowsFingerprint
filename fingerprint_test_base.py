...
def get_registry_config():
    ...
    return [
        validatable_record.ValidatableRecord(
            test_type=TestType.network_fingerprint,
        ...
        validatable_record.ValidatableRecord(
            ...
            validation_format=ValidationType.host_name),
        validatable_record.ValidatableRecord(
            test_type=TestType.windows_fingerprint,
            path="SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion",
            name="BuildGUID",
        ...
        validatable_record.ValidatableRecord(
            test_type=TestType.hardware_fingerprint,
        ...
        validatable_record.ValidatableRecord(
            test_type=TestType.telemetry_fingerprint,
